...
const nodes: NodeData[] = [
  {
    ...
    y: 120,
    color: "#00f0ff",
    description: "Full-stack web architecture with Next.js, React, and edge-first deployment strategies.",
    metrics: [
      { label: "Frameworks", value: "Next.js, React, Vue" },
      { label: "Avg TTFB", value: "< 85ms" },
  ...
  },
  {
    ...
    y: 80,
    color: "#39ff14",
    description: "Technical SEO engineering — schema automation, Core Web Vitals optimization, crawl efficiency.",
    metrics: [
      { label: "Avg Traffic Lift", value: "+340%" },
      { label: "CWV Pass Rate", value: "98%" },
  ...
  },
  {
    ...
    y: 240,
    color: "#ff6a00",
    description: "Workflow orchestration, CI/CD pipelines, and AI-powered process automation.",
    metrics: [
      { label: "Workflows Built", value: "47" },
      { label: "Ops Reduced", value: "80%" },
      { label: "Integrations", value: "12 APIs" },
    ],
  },
  {
    id: "ai",
    ...
    y: 280,
    color: "#ff00e5",
    description: "AI integration — LLM orchestration, custom agents, intelligent routing systems.",
    metrics: [
      { label: "Models Used", value: "GPT-4, Claude, Llama" },
      { label: "Agents Built", value: "8" },
  ...
  },
  {
    ...
    y: 240,
    color: "#00f0ff",
    description: "Custom analytics platforms, event instrumentation, conversion tracking, and predictive models.",
    metrics: [
      { label: "Events/Day", value: "50M+" },
      { label: "Dashboards", value: "15" },
      { label: "Prediction Acc.", value: "67%" },
    ],
  },
  {
    id: "devops",
    ...
    y: 100,
    color: "#39ff14",
    description: "Container orchestration, infrastructure as code, zero-downtime deployments.",
    metrics: [
      { label: "Uptime", value: "99.97%" },
      { label: "Deploy Time", value: "< 3min" },
      { label: "Environments", value: "AWS, Vercel, GCP" },
    ],
  },
];
